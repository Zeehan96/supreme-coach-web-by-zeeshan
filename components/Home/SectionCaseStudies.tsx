...
const SectionCaseStudies = () => {
  return (
    <div className="section_case-studies">
      <div className="padding-section-xmedium">
        <div className="padding-global">
          <div className="container-xlarge">
            <div className="bento_outer-component">
              <div className="max-width-small">
                <h2 className="heading-style-h3-v2">Case Studies</h2>
              </div>
              <div className="bento_grid-outer cards">
                <div
                  id="w-node-_4fbafc56-9a73-c3c0-72c3-83c213a80f91-41695672"
                  className="w-dyn-list"
                >
                  <div role="list" className="w-dyn-items">
                    <div
                      role="listitem"
                      className="case_study-card-item w-dyn-item"
                    >
                      <div className="case_study-img">
                        <div className="case_study-img-cover is-cyan w-condition-invisible"></div>
                        <div className="case_study-img-cover is-purple w-condition-invisible"></div>
                      </div>
                      <div className="case_card-texts">
                        <div className="label-small color-neutral-500">
                          Customer Story
                        </div>
                        <div className="long-article-title">
                          <h3 className="heading-style-h5-v2 case-study-title-long">
                            How Guidde made creators a scalable growth channel
                            with Supreme Coach
                          </h3>
                        </div>
                        <div className="color-neutral-800">
                          <div className="text-size-regular-v2">
                            Guidde is the generative AI platform for business
                            that helps teams create video documentation 11x
                            faster.
                          </div>
                        </div>
                        <div className="case_card-bottom">
                          <div className="min-wrapper">
                            <div className="text-size-regular">4</div>
                            <div className="text-size-regular">min read</div>
                          </div>
                          <a
                            aria-label="customer-story-link"
                            href="/partner-story/guidde"
                ...
                <div className="w-dyn-list">
                  <div
                    role="list"
                    className="case_study-bento-grid w-dyn-items"
                  >
                    <div
                      id="w-node-ce788772-9d62-c1c5-d13b-a91b1bb234d8-41695672"
                      role="listitem"
                      className="w-dyn-item"
                    >
                      <div className="case_study-card-item">
                        <div className="case_study-img is-small">
                          <div className="case_study-img-cover is-purple w-condition-invisible"></div>
                          <div className="case_study-img-cover is-cyan"></div>
                        </div>
                        <div className="case_card-texts small">
                          <div className="label-small color-neutral-500">
                            Customer Story
                          </div>
                          <h3 className="heading-style-h6-v2 case-study-title">
                            Becoming the definitive AI-first Customer Service
                            Platform
                          </h3>
                          <div className="case_card-bottom">
                            <div className="min-wrapper">
                              <div className="text-size-regular">5</div>
                              <div className="text-size-regular">min read</div>
                            </div>
                            <a
                              aria-label="customer-story-link"
                              href="/partner-story/intercom"
                              className="button-dark is-small w-inline-block"
                            >
                              <div>Read more</div>
                              <div className="icon-embed-xxsmall w-embed">
                    ...
                    >
                      <div className="case_study-card-item">
                        ...
                        <div className="case_card-texts small">
                          ...
                          <h3 className="heading-style-h6-v2 case-study-title">
                            How Freshbooks reached 2M+ impressions with Supreme
                            Coach{" "}
                          </h3>
                          <div className="case_card-bottom">
                            <div className="min-wrapper">

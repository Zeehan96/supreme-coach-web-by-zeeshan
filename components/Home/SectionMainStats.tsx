...
const agentAvatars: string[] = [
  "https://images.ctfassets.net/w8fc6tgspyjz/zGNqCa9rqcPKS35lBTec8/9ce4bc8a74c4b140672e3bb7aab12519/agent-001.png",
  "https://images.ctfassets.net/w8fc6tgspyjz/2R7DchUdbRc9r4LgMClRDI/00cfb93bb39b602ef76c0ec246689ee4/agent-002.png",
  "https://images.ctfassets.net/w8fc6tgspyjz/5hoFAlJB1xFyfSDkNx26mC/4c1fff3d6fb3d7bec4a2c968d1e1f81d/agent-003.png",
  "https://images.ctfassets.net/w8fc6tgspyjz/4WGIGlivzspWdgwzTdBo9m/fbfa9445710e548f6de36be05204e1a3/agent-004.png",
];
                  ...
                  {contentData[activeTab].agents.map((agent: any, idx: number) => (
                    ...
                    >
                      <div style={{
                        ...
                        <img
                          src={agentAvatars[idx] ?? agentAvatars[agentAvatars.length - 1]}
                          alt={agent.text}
                          style={{
                            width: "40px",
                            height: "40px",

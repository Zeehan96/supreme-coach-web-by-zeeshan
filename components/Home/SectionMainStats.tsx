...
const SectionMainStats = () => {
  ...
  const handleSlideClick = (slideKey: string) => {
    if (activeSlide === slideKey) {
      // Optional: Toggle off if clicking the same one? User said "close button" so maybe not.
      // But usually nice. Let's keep it simple: click updates active.
      // setActiveSlide(null); 
    } else {
    ...
    <div className="section_main-stats">
      <div className="padding-section-xmedium">
        <div className="padding-global">
                ...
                <div className="b2b_cards-outer">
                  ...
                  >
                    <div className="swiper-wrapper basic-swiper-wrapper">
                      <div
                        onClick={() => handleSlideClick('linkedin')}
                        style={{
                          cursor: 'pointer',
                          border: activeSlide === 'linkedin' ? '2px solid #000' : 'none',
                          borderRadius: '16px',
                          transition: 'all 0.3s ease',
                          transform: activeSlide === 'linkedin' ? 'scale(1.02)' : 'scale(1)'
                        }}
                      ...
                      <div
                        onClick={() => handleSlideClick('podcast')}
                        style={{
                          cursor: 'pointer',
                          border: activeSlide === 'podcast' ? '2px solid #000' : 'none',
                          borderRadius: '16px',
                          transition: 'all 0.3s ease',
                          transform: activeSlide === 'podcast' ? 'scale(1.02)' : 'scale(1)'
                        }}
                      ...
                      <div
                        onClick={() => handleSlideClick('instagram')}
                        style={{
                          cursor: 'pointer',
                          border: activeSlide === 'instagram' ? '2px solid #000' : 'none',
                          borderRadius: '16px',
                          transition: 'all 0.3s ease',
                          transform: activeSlide === 'instagram' ? 'scale(1.02)' : 'scale(1)'
                        }}
                      ...
                      <div
                        onClick={() => handleSlideClick('twitter')}
                        style={{
                          cursor: 'pointer',
                          border: activeSlide === 'twitter' ? '2px solid #000' : 'none',
                          borderRadius: '16px',
                          transition: 'all 0.3s ease',
                          transform: activeSlide === 'twitter' ? 'scale(1.02)' : 'scale(1)'
                        }}
                      ...
                      <div
                        onClick={() => handleSlideClick('tiktok')}
                        style={{
                          cursor: 'pointer',
                          border: activeSlide === 'tiktok' ? '2px solid #000' : 'none',
                          borderRadius: '16px',
                          transition: 'all 0.3s ease',
                          transform: activeSlide === 'tiktok' ? 'scale(1.02)' : 'scale(1)'
                        }}
                      ...
                      <div
                        onClick={() => handleSlideClick('newsletter')}
                        style={{
                          cursor: 'pointer',
                          border: activeSlide === 'newsletter' ? '2px solid #000' : 'none',
                          borderRadius: '16px',
                          transition: 'all 0.3s ease',
                          transform: activeSlide === 'newsletter' ? 'scale(1.02)' : 'scale(1)'
                        }}
                      ...
                      <div
                        onClick={() => handleSlideClick('youtube')}
                        style={{
                          cursor: 'pointer',
                          border: activeSlide === 'youtube' ? '2px solid #000' : 'none',
                          borderRadius: '16px',
                          transition: 'all 0.3s ease',
                          transform: activeSlide === 'youtube' ? 'scale(1.02)' : 'scale(1)'
                        }}
          ...
          {activeSlide && contentData[activeSlide] && (
            <div
              ref={detailsRef}
            ...
            >
              ...
              <div className="details-left">
                ...
                <p style={{ fontSize: '1.125rem', color: '#666', marginBottom: '2rem', maxWidth: '400px' }}>
                  {contentData[activeSlide].description}
                </p>
                ...
                <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                  {contentData[activeSlide].checklist.map((item: string, idx: number) => (
              ...
              <div className="details-right">
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  {contentData[activeSlide].agents.map((agent: any, idx: number) => (
                    <div key={idx} style={{
                      background: '#fff',
                      borderRadius: '16px',
                      padding: '16px 20px',
                      ...
                      <div style={{
                        ...
                        height: '40px',
                        borderRadius: '50%',
                        background: '#f0f0f0', // Placeholder for avatar
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        flexShrink: 0

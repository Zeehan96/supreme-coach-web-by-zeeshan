          ...
          <div className="hero_component v2-centered">
            <div className="hero_texts-middle">
              <div className="hero_texts-heading-side">
                <div className="meta-text is-large">Creator Pricing</div>
                <h1 className="heading-style-h2-v2">
                  Monetize your content. No out-of-pocket costs
                </h1>
              </div>
              <div className="buttons_hero-outer">
                <div className="text-size-medium-v2 text-weight-medium">
                  Supreme Coach is always free for creators. We make money when
                  you make money—through a small percentage of the sponsorship
                  fee.
                </div>

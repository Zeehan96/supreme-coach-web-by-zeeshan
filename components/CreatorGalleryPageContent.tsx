...
export default function CreatorGalleryPageContent() {
  useEffect(() => {
          ...
          <div className="padding-global">
            <div className="container-xlarge">
              <div className="creator-hero_component">
                <div className="hero_texts-wrapper creator-gallery">
                  ...
                  <div className="max-width-small creator-gallery-para">
                  ...
                  <div className="creator-gallery_hero-buttons">
                    <Link
                      href="/get-access"
                      target="_blank"
          ...
          <div className="padding-global padding-section-medium">
            <div className="container-large">
              <div className="customer_articles">
                <Link
                  href="/blog/how-masters-of-work-runs-their-productivity-newsletter-ads-business-on-supreme-coach"
                ...
                <Link
                  href="/blog/how-superpower-daily-makes-5-figures-with-supreme-coach"
                  className="customer_card w-inline-block"
                >
                ...
                <Link
                  href="/blog/how-superhuman-built-the-largest-newsletter-ads-business-in-ai-with-supreme-coach"
                  className="customer_card w-inline-block"
                >
                  <div className="customer_card-red">4 Min Read</div>
                  <div className="customer_card-title">
